...
#endif
{
	...
	{
		s_clipPlanePos0 = -s_clipPos0->z * s_rcgpuState.nearPlaneHalfLen;
		s_clipPlanePos1 = -s_clipPos1->z * s_rcgpuState.nearPlaneHalfLen;
		...
		if (s_clipPos0->x < s_clipPlanePos0 || s_clipPos1->x < s_clipPlanePos1)
		{
			...
			s_clipParam1 = -dz*s_rcgpuState.nearPlaneHalfLen - dx;
			...
			s_clipIntersectX = -s_clipIntersectZ * s_rcgpuState.nearPlaneHalfLen;
	...
	for (s32 i = 0; i < srcVertexCount; i++)
	{
		...
		if (s_clipPos0->x > s_clipPlanePos0 || s_clipPos1->x > s_clipPlanePos1)
		{
			...
			s_clipParam0 = (x0*z1) - (x1*z0);
			s_clipParam1 = s_rcgpuState.nearPlaneHalfLen*dz - dx;
			...
			s_clipIntersectX = s_rcgpuState.nearPlaneHalfLen * s_clipIntersectZ;
	...
	for (s32 i = 0; i < srcVertexCount; i++)
	{
		s_clipY0 = s_rcgpuState.yPlaneTop * s_clipPos0->z;
		s_clipY1 = s_rcgpuState.yPlaneTop * s_clipPos1->z;
		...
		if (s_clipPos0->y < s_clipY0 || s_clipPos1->y < s_clipY1)
		{
			...
			const f32 dz = s_clipPos1->z - s_clipPos0->z;
			s_clipParam1 = s_rcgpuState.yPlaneTop*dz - dy;
			...
			s_clipIntersectY = s_rcgpuState.yPlaneTop * s_clipIntersectZ;
	...
	for (s32 i = 0; i < srcVertexCount; i++)
	{
		s_clipY0 = s_rcgpuState.yPlaneBot * s_clipPos0->z;
		s_clipY1 = s_rcgpuState.yPlaneBot * s_clipPos1->z;
		...
		if (s_clipPos0->y > s_clipY0 || s_clipPos1->y > s_clipY1)
		{
			...
			const f32 dy = s_clipPos1->y - s_clipPos0->y;
			const f32 dz = s_clipPos1->z - s_clipPos0->z;
			s_clipParam1 = s_rcgpuState.yPlaneBot*dz - dy;
			...
			s_clipIntersectY = s_rcgpuState.yPlaneBot * s_clipIntersectZ;
			const f32 aDz = TFE_Jedi::abs(s_clipPos1->z - s_clipPos0->z);
			const f32 aDy = TFE_Jedi::abs(s_clipPos1->y - s_clipPos0->y);
